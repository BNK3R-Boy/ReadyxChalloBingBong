...
Global InfoArray := {Instagram: ({TITLE: "Instagram: " . ((ONLINE) ? "Loading..." : "Disconnected")
			...
			, Twitter: ({TITLE: "Twitter: " . ((ONLINE) ? "Loading..." : "Disconnected"), URL: -1, HURL: 0, BHTITLE: "", HTITLE: "Initialisation...", RSS: "https://rssbox.us-west-2.elasticbeanstalk.com/twitter/1287773674209251329/Readyx_?include_rts=0&exclude_replies=1", CURL: "https://twitter.com/Readyx_", STATE: 1, NewPost: 0})
